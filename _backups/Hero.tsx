...
import { HeroBlueprint, HeroBlueprintLeft } from '../components/blueprint/TechnicalBlueprint';
        ...
        >
          ...
          >
            ...
            <div className="hero__meta-right">
              ...
              {/* Section 6: Reserved visual space for circular photo (does not dominate) */}
              <div
                className="hero__avatar-slot"
                title={`${personalData.name} — Profile space`}
                aria-label={`${personalData.name} profile space`}
              >
                <span className="hero__avatar-initials">{personalData.initials}</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
