...
import TechnicalDoodle from './TechnicalDoodle';
...
export function HeroBlueprint() {
  return (
    <div className="bp-hero-container" aria-hidden="false">
      {/* Connecting trajectory SVG */}
      <svg
        className="bp-svg"
        width="140"
        height="220"
        ...
        aria-hidden="true"
      >
        {/* Curved dashed flow down */}
        <path
          d="M70 65 C70 120 105 150 105 200"
          className="bp-path bp-path--animated"
          strokeWidth="1.5"
        />
        {/* Terminal arrow */}
        <polygon points="105,206 101,198 109,198" className="bp-arrow" />
        {/* Origin node */}
        <circle cx="70" cy="65" r="3" className="bp-node" />
      </svg>

      {/* Floating Technical Object: TechnicalDoodle 3D Model */}
      <div
        className="bp-object bp-object--drift-a technical-doodle-slot"
        style={{ top: '6px', left: '16px' }}
      >
        <TechnicalDoodle size={100} />
        <span className="bp-tag">[MODEL]</span>
        <span className="bp-coord">NODE // 02</span>
      </div>
    </div>
  );
}
...
/**
 * Hero Blueprint Left — outer left whitespace coordinate mark.
 * A small build/code coordinate symbol with a subtle path to add intentionality
 * to the empty left margin.
 */
export function HeroBlueprintLeft() {
  return (
    <div className="bp-hero-left-container" aria-hidden="true">
      <svg
        className="bp-svg"
        width="100"
        height="160"
        ...
        aria-hidden="true"
      >
        {/* Small L-shaped coordinate mark */}
        <path
          d="M20 20 L20 80 L60 80"
          className="bp-path"
          strokeWidth="1.5"
        />
        {/* Corner node */}
        <circle cx="20" cy="80" r="3" className="bp-node bp-node--accent" />
        {/* End node */}
        <circle cx="60" cy="80" r="2.5" className="bp-node" />
        {/* Small downward tail */}
        <path
          d="M20 80 L20 140"
          className="bp-path bp-path--solid"
          strokeWidth="1"
          opacity="0.6"
        />
      </svg>
      <div className="bp-object bp-object--drift-c" style={{ top: '8px', left: '6px' }}>
        <span className="bp-tag" style={{ marginTop: 0 }}>[BUILD // 00]</span>
        <span className="bp-coord">SRC // ORIGIN</span>
      </div>
    </div>
  );
}
